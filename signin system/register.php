...
?>
    ...
    <?php
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            require ('signin system/register-process.php');
        }
    ?>
        ...
        <div class="row m-0">
            <div class="col-lg-4 offset-lg-2">
                <div class="text-center pb-5">
                    ...
                    <span class="font-ubuntu text-black-50">I already have <a href="signin system/login.php">Login</a></span>
                </div>
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <div class="d-flex justify-content-center">
                            <img class="camera-icon" src="signin system/assets/camera-solid.svg" alt="camera">
                        </div>
                        <img src="signin system/assets/profile/beard.png" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                        <small class="form-text text-black-50">Choose Image</small>
                        <input type="file" form="reg-form" class="form-control-file" name="profileUpload" id="upload-profile">
                    </div>
                </div>
                <div class="d-flex justify-content-center">
                    <form action="signin system/register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        <div class="form-row">
                            <div class="col">
